...
//        path = './questions_money.wav';
        path = './questions_money_audio_decodificado.wav';
...
//        wavwrite(audio_codificado, Fs_audio, './questions_money_audio_codificado.wav')
        wavwrite(audio_codificado, Fs_audio, './questions_money_audio_decodificado.wav')
